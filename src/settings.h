...
Button page1[FOOT_BUTTONS_NUM] = {
    ...
    {.type=BUTTON_BLOCK_BYPASS, .color=COLOR_BLACK, .availableColor=COLOR_GREEN, .value=AXEFX_BLOCK_LOOPER},
...
Button page2[FOOT_BUTTONS_NUM] = {
    // 1 2 3 4
    {.type=BUTTON_BLOCK_BYPASS, .color=COLOR_GREEN, .availableColor=COLOR_YELLOW, .value=AXEFX_BLOCK_DRIVE_1},
    {.type=BUTTON_BLOCK_BYPASS, .color=COLOR_GREEN, .availableColor=COLOR_YELLOW, .value=AXEFX_BLOCK_DRIVE_2},
    {.type=BUTTON_BLOCK_BYPASS, .color=COLOR_GREEN, .availableColor=COLOR_YELLOW, .value=AXEFX_BLOCK_DELAY_1},
    {.type=BUTTON_BLOCK_BYPASS, .color=COLOR_GREEN, .availableColor=COLOR_YELLOW, .value=AXEFX_BLOCK_DELAY_2},
    // 5
    {.type=BUTTON_PAGE, .color=COLOR_RED, .value=0},
    // 6 7 8 9 10
    {.type=BUTTON_BLOCK_BYPASS, .color=COLOR_GREEN, .availableColor=COLOR_YELLOW, .value=AXEFX_BLOCK_CHORUS_1},
    {.type=BUTTON_BLOCK_BYPASS, .color=COLOR_GREEN, .availableColor=COLOR_YELLOW, .value=AXEFX_BLOCK_TREMOLO_PANNER_1},
    {.type=BUTTON_BLOCK_BYPASS, .color=COLOR_GREEN, .availableColor=COLOR_YELLOW, .value=AXEFX_BLOCK_SYNTH_1},
    {.type=BUTTON_BLOCK_BYPASS, .color=COLOR_GREEN, .availableColor=COLOR_YELLOW, .value=AXEFX_BLOCK_PITCH_1},
    {.type=BUTTON_BLOCK_BYPASS, .color=COLOR_GREEN, .availableColor=COLOR_YELLOW, .value=AXEFX_BLOCK_WAH_1},
